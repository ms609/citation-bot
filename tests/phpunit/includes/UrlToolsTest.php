...
final class UrlToolsTest extends testBaseClass {
    ...
    public function testOxLit(): void {
        $text = '{{cite web|url=https://oxfordre.com/literature/view/10.1093/acrefore/9780190201098.001.0001/acrefore-9780190201098-e-1357|doi-broken-date=X|doi=10.3421/32412xxxxxxx|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
    ...
    public function testOxComms(): void {
        $text = '{{cite web|url=https://oxfordre.com/communication/communication/view/10.1093/acrefore/9780190228613.001.0001/acrefore-9780190228613-e-1195|doi-broken-date=X|doi=10.3421/32412xxxxxxx|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->process_citation($text);
    ...
    public function testGroveMusic1(): void {
        $text = '{{cite web |url=https://doi.org/10.1093/gmo/9781561592630.article.J441700 |title=Tatum, Art(hur, Jr.) (jazz) |last1=Howlett |first1=Felicity | website=Grove Music Online |publisher=Oxford University Press |date=2002 |access-date=November 20, 2018 |url-access=subscription|via=Grove Music Online|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->process_citation($text);
        $this->assertSame('{{cite web |url=https://doi.org/10.1093/gmo/9781561592630.article.J441700 |title=Tatum, Art(hur, Jr.) (jazz) |last1=Howlett |first1=Felicity | website=Grove Music Online |publisher=Oxford University Press |date=2002 |doi=10.1093/gmo/9781561592630.article.J441700 |access-date=November 20, 2018 |url-access=subscription|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}', $template->parsed_text());
    }

    public function testGroveMusic2(): void {
        $text = '{{cite web |url=https://doi.org/10.1093/gmo/9781561592630.article.J441700 |title=Tatum, Art(hur, Jr.) (jazz) |last1=Howlett |first1=Felicity | website=Grove Music Online |publisher=Oxford University Press |date=2002|via=Grove Music Online|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->process_citation($text);
        $this->assertSame('{{cite web |url=https://doi.org/10.1093/gmo/9781561592630.article.J441700 |title=Tatum, Art(hur, Jr.) (jazz) |last1=Howlett |first1=Felicity | website=Grove Music Online |publisher=Oxford University Press |date=2002|doi=10.1093/gmo/9781561592630.article.J441700 |pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}', $template->parsed_text());
    }

    public function testGroveMusic3(): void {
        $text = '{{cite web |url=https://doi.org/10.1093/gmo/9781561592630.article.J441700 |title=Tatum, Art(hur, Jr.) (jazz) |last1=Howlett |first1=Felicity |publisher=Oxford University Press |date=2002|via=Grove Music Online|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->process_citation($text);
        $this->assertSame('{{cite web |url=https://doi.org/10.1093/gmo/9781561592630.article.J441700 |title=Tatum, Art(hur, Jr.) (jazz) |last1=Howlett |first1=Felicity |publisher=Oxford University Press |date=2002|doi=10.1093/gmo/9781561592630.article.J441700 |via=Grove Music Online|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}', $template->parsed_text());
    }

    public function testGroveMusic4(): void {
        $text = '{{cite web |url=https://doi.org/10.1093/gmo/9781561592630.article.J441700 |title=Tatum, Art(hur, Jr.) (jazz) |last1=Howlett |first1=Felicity |publisher=Oxford University Press |date=2002|website=Grove Music Online|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->process_citation($text);
        $this->assertSame('{{cite web |url=https://doi.org/10.1093/gmo/9781561592630.article.J441700 |title=Tatum, Art(hur, Jr.) (jazz) |last1=Howlett |first1=Felicity |publisher=Oxford University Press |date=2002|website=Grove Music Online|doi=10.1093/gmo/9781561592630.article.J441700 |pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}', $template->parsed_text());
    }

    public function testGroveMusic5(): void {
        $text = '{{cite web |url=https://doi.org/10.1093/gmo/9781561592630.article.J441700 |title=Tatum, Art(hur, Jr.) (jazz) |last1=Howlett |first1=Felicity |publisher=Oxford University Press |date=2002|website=Grove Music Online|via=The Dog Farm|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->process_citation($text);
        $this->assertSame('{{cite web |url=https://doi.org/10.1093/gmo/9781561592630.article.J441700 |title=Tatum, Art(hur, Jr.) (jazz) |last1=Howlett |first1=Felicity |publisher=Oxford University Press |date=2002|website=Grove Music Online|doi=10.1093/gmo/9781561592630.article.J441700 |via=The Dog Farm|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}', $template->parsed_text());
    }
    ...
    public function testURLCleanUp6(): void {
        $text = '{{cite book|url=https://www-jstor-org.libezp.lib.lsu.edu/stable/10.7249/j.ctt4cgd90.10|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $template->get_identifiers_from_url();
    ...
    public function testURLCleanUp10(): void {
        $text = '{{cite book|url=https://archive.org/detail/jstor-12345|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $template->get_identifiers_from_url();
        $this->assertNotNull($template->get2('url'));
        $this->assertSame('12345', $template->get2('jstor'));
    ...
    public function testURLCleanUp12(): void {
        $text = '{{cite journal|url=https://dx.doi.org/10.0001/Rubbish_bot_failure_test}}'; // Add bogus
        $template = $this->make_citation($text);
        $this->assertTrue($template->get_identifiers_from_url());
        $this->assertNotNull($template->get2('url'));
        $this->assertSame('10.0001/Rubbish_bot_failure_test', $template->get2('doi'));
    }

    public function testURLCleanUp13(): void {
        $text = '{{cite journal|url=https://dx.doi.org/10.0001/Rubbish_bot_failure_test2|doi=10.0001/Rubbish_bot_failure_test}}'; // Fail to add bogus
        $template = $this->make_citation($text);
        $this->assertFalse($template->get_identifiers_from_url());
        $this->assertSame('https://dx.doi.org/10.0001/Rubbish_bot_failure_test2', $template->get2('url'));
        $this->assertSame('10.0001/Rubbish_bot_failure_test', $template->get2('doi'));
    }

    public function testURLCleanUp14(): void {
        $text = '{{cite journal|url=https://dx.doi.org/10.1093/oi/authority.x|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}'; // A particularly semi-valid DOI
        $template = $this->make_citation($text);
        $this->assertFalse($template->get_identifiers_from_url());
    ...
    public function testURLCleanUp15(): void {
        $text = '{{cite journal|doi=10.5284/1000184|url=https://dx.doi.org/10.5284/1000184XXXXXXXXXX|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $this->assertFalse($template->get_identifiers_from_url());
        $this->assertNotNull($template->get2('url'));
    ...
    public function testURLCleanUp16(): void {
        $text = '{{cite journal|doi= 10.1093/oi/authority.x|url=https://dx.doi.org/10.1093/oi/authority.xXXXXXXXXXX.pdf|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $this->assertFalse($template->get_identifiers_from_url());
    ...
    public function testURLCleanUp17(): void {
        $text = '{{cite journal|url=https://SomeRandomWeb.com/10.5284/1000184|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $this->assertFalse($template->get_identifiers_from_url());
    ...
    public function testURLCleanUp18(): void {
        $text = '{{cite journal|url=https://www.jstor.org/stable/1986280?origin=324124324|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $this->assertTrue($template->get_identifiers_from_url());
    ...
    public function testURLCleanUp19(): void {
        $text = '{{cite journal|url=https://dx.doi.org/10.0001/Rubbish_bot_failure_test|doi=10.0001/Rubbish_bot_failure_test|doi-access=free|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $this->assertFalse($template->get_identifiers_from_url());
        $this->assertNull($template->get2('url'));
    }
    ...
    public function testOxforddnbDOIs1(): void {
        $text = '{{cite web|url=https://www.oxforddnb.com/view/10.1093/ref:odnb/9780198614128.001.0001/odnb-9780198614128-e-33369|doi=10.0001/Rubbish_bot_failure_test|doi-broken-date=Y|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->process_citation($text);
    ...
    public function testOxforddnbDOIs2(): void {
        $text = '{{cite web|url=https://www.oxforddnb.com/view/10.1093/odnb/9780198614128.001.0001/odnb-9780198614128-e-108196|doi=10.0001/Rubbish_bot_failure_test|doi-broken-date=Y|title=Joe Blow - Oxford Dictionary of National Biography|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->process_citation($text);
    ...
    public function testANBDOIs(): void {
        $text = '{{cite web|url=https://www.anb.org/view/10.1093/anb/9780198606697.001.0001/anb-9780198606697-e-1800262|doi=10.0001/Rubbish_bot_failure_test|doi-broken-date=Y|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $template->tidy_parameter('url');
    ...
    public function testArtDOIs(): void {
        $text = '{{cite web|url=https://www.oxfordartonline.com/benezit/view/10.1093/benz/9780199773787.001.0001/acref-9780199773787-e-00183827|doi=10.0001/Rubbish_bot_failure_test|doi-broken-date=Y|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $template->tidy_parameter('url');
    ...
    public function testGroveDOIs(): void {
        $text = '{{cite web|url=https://www.oxfordartonline.com/groveart/view/10.1093/gao/9781884446054.001.0001/oao-9781884446054-e-7000082129|doi=10.0001/Rubbish_bot_failure_test|doi-broken-date=Y|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $template->tidy_parameter('url');
    ...
    public function testGroveDOIs2(): void {
        $text = '{{cite web|url=https://www.oxfordartonline.com/groveart/view/10.1093/gao/9781884446054.001.0001/oao-9781884446054-e-7002085714|doi=10.0001/Rubbish_bot_failure_test|doi-broken-date=Y|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $template->tidy_parameter('url');
    ...
    public function testAASCDOIs(): void {
        $text = '{{cite web|url=https://oxfordaasc.com/view/10.1093/acref/9780195301731.001.0001/acref-9780195301731-e-41463|doi=10.0001/Rubbish_bot_failure_test|doi-broken-date=Y|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $template->tidy_parameter('url');
    ...
    public function testWhoWhoDOIs(): void {
        $text = '{{cite web|url=https://www.ukwhoswho.com/view/10.1093/ww/9780199540891.001.0001/ww-9780199540884-e-37305|doi=10.0001/Rubbish_bot_failure_test|doi-broken-date=Y|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $template->tidy_parameter('url');
    ...
    public function testMusicDOIsA(): void {
        $text = '{{cite web|url=https://www.oxfordmusiconline.com/grovemusic/view/10.1093/gmo/9781561592630.001.0001/omo-9781561592630-e-1002242442|doi=10.0001/Rubbish_bot_failure_test|doi-broken-date=Y|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $template->tidy_parameter('url');
    ...
    public function testMusicDOIsL(): void {
        $text = '{{cite web|url=https://www.oxfordmusiconline.com/grovemusic/view/10.1093/gmo/9781561592630.001.0001/omo-9781561592630-e-4002232256|doi=10.0001/Rubbish_bot_failure_test|doi-broken-date=Y|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $template->tidy_parameter('url');
    ...
    public function testMusicDOIsJ(): void {
        $text = '{{cite web|url=https://www.oxfordmusiconline.com/grovemusic/view/10.1093/gmo/9781561592630.001.0001/omo-9781561592630-e-2000095300|doi=10.0001/Rubbish_bot_failure_test|doi-broken-date=Y|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $template->tidy_parameter('url');
    ...
    public function testLatinDOIs(): void {
        $text = '{{cite web|url=https://oxfordre.com/latinamericanhistory/view/10.1093/acrefore/9780199366439.001.0001/acrefore-9780199366439-e-2|doi=10.0001/Rubbish_bot_failure_test|doi-broken-date=Y|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $template->tidy_parameter('url');
    ...
    public function testEnvDOIs(): void {
        $text = '{{cite web|url=https://oxfordre.com/environmentalscience/view/10.1093/acrefore/9780199389414.001.0001/acrefore-9780199389414-e-224|doi=10.0001/Rubbish_bot_failure_test|doi-broken-date=Y|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $template->tidy_parameter('url');
    ...
    public function testAmHistDOIs(): void {
        $text = '{{cite web|url=https://oxfordre.com/view/10.1093/acrefore/9780199329175.001.0001/acrefore-9780199329175-e-17|doi=10.0001/Rubbish_bot_failure_test|doi-broken-date=Y|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $template->tidy_parameter('url');
    ...
    public function testIntStudDOIs(): void {
        $text = '{{cite web|url=https://oxfordre.com/view/10.1093/acrefore/9780190846626.001.0001/acrefore-9780190846626-e-39|doi=10.0001/Rubbish_bot_failure_test|doi-broken-date=Y|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $template->tidy_parameter('url');
    ...
    public function testClimateDOIs(): void {
        $text = '{{cite web|url=https://oxfordre.com/climatescience/view/10.1093/acrefore/9780190228620.001.0001/acrefore-9780190228620-e-699|doi=10.0001/Rubbish_bot_failure_test|doi-broken-date=Y|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $template->tidy_parameter('url');
    ...
    public function testAnthroDOIs(): void {
        $text = '{{cite web|url=https://oxfordre.com/anthropology/view/10.1093/acrefore/9780190854584.001.0001/acrefore-9780190854584-e-45|doi=10.0001/Rubbish_bot_failure_test|doi-broken-date=Y|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $template->tidy_parameter('url');
    ...
    public function testPsychDOIs(): void {
        $text = '{{cite web|url=https://oxfordre.com/psychology/view/10.1093/acrefore/9780190236557.001.0001/acrefore-9780190236557-e-384|doi=10.0001/Rubbish_bot_failure_test|doi-broken-date=Y|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $template->tidy_parameter('url');
    ...
    public function testPoliDOIs(): void {
        $text = '{{cite web|url=https://oxfordre.com/politics/view/10.1093/acrefore/9780190228637.001.0001/acrefore-9780190228637-e-181|doi=10.0001/Rubbish_bot_failure_test|doi-broken-date=Y|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $template->tidy_parameter('url');
    ...
    public function testOxPressDOIs(): void {
        $text = '{{cite web|url=https://oxford.universitypressscholarship.com/view/10.1093/oso/9780190124786.001.0001/oso-9780190124786|doi=10.0001/Rubbish_bot_failure_test|doi-broken-date=Y|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $template->tidy_parameter('url');
    ...
    public function testMedDOIs(): void {
        $text = '{{cite web|url=https://oxfordmedicine.com/view/10.1093/med/9780199592548.001.0001/med-9780199592548-chapter-199|doi=10.0001/Rubbish_bot_failure_test|doi-broken-date=Y|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $template->tidy_parameter('url');
    ...
    public function testUnPressScholDOIs(): void {
        $text = '{{cite web|url=https://oxford.universitypressscholarship.com/view/10.1093/oso/9780198814122.001.0001/oso-9780198814122-chapter-5|doi=10.0001/Rubbish_bot_failure_test|doi-broken-date=Y|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $template->tidy_parameter('url');
    ...
    public function testUnPressScholDOIsType2(): void {
        $text = '{{cite web|url=https://oxford.universitypressscholarship.com/view/10.1093/acprof:oso/9780199812295.001.0001/oso-9780199812295-chapter-7|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $template->tidy_parameter('url');
    ...
    public function testOxHandbookDOIs(): void {
        $text = '{{cite web|url=https://www.oxfordhandbooks.com/view/10.1093/oxfordhb/9780198824633.001.0001/oxfordhb-9780198824633-e-1|doi=10.0001/Rubbish_bot_failure_test|doi-broken-date=Y|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $template->tidy_parameter('url');
    ...
    public function testConversionOfURL10(): void {
        $text = '{{cite web|url=https://ncbi.nlm.nih.gov/entrez/eutils/elink.fcgi?dfastool=sumsearch.org&&id=123456|title=Xyz|pmc=333333|doi=10.0001/Rubbish_bot_failure_test}}';
        $template = $this->make_citation($text);
        $this->assertFalse($template->get_identifiers_from_url());
        $this->assertNotNull($template->get2('url'));
    }
    ...
    public function testConversionOfURL10B(): void {
        $text = '{{cite web|url=https://ncbi.nlm.nih.gov/entrez/eutils/elink.fcgi?dfastool=sumsearch.org&&id=123456|pmid=123456|title=Xyz|pmc=333333|doi=10.0001/Rubbish_bot_failure_test}}';
        $template = $this->make_citation($text);
        $this->assertFalse($template->get_identifiers_from_url());
        $this->assertNull($template->get2('url'));
    }
    ...
    public function testConversionOfURL11(): void {
        $text = '{{cite web|url=https://zbmath.org/?q=an:7511.33034|title=Xyz|pmc=333333|doi=10.0001/Rubbish_bot_failure_test|doi-access=free}}';
        $template = $this->make_citation($text);
        $this->assertTrue($template->get_identifiers_from_url());
        $this->assertNull($template->get2('url'));
    }
    ...
    public function testConversionOfURL12(): void {
        $text = '{{cite web|url=https://www.osti.gov/biblio/1760327-generic-advanced-computing-framework-executing-windows-based-dynamic-contingency-analysis-tool-parallel-cluster-machines|title=Xyz|pmc=333333|doi=10.0001/Rubbish_bot_failure_test|doi-access=free}}';
        $template = $this->make_citation($text);
        $this->assertTrue($template->get_identifiers_from_url());
        $this->assertNull($template->get2('url'));
    }
    ...
    public function testConversionOfURL13(): void {
        $text = '{{cite web|url=https://zbmath.org/?q=an:75.1133.34|title=Xyz|pmc=333333|doi=10.0001/Rubbish_bot_failure_test|doi-access=free}}';
        $template = $this->make_citation($text);
        $this->assertTrue($template->get_identifiers_from_url());
        $this->assertNull($template->get2('url'));
    }
    ...
    public function testConversionOfURL15(): void {
        $text = '{{cite web | url=https://www.osti.gov/energycitations/product.biblio.jsp?osti_id=2341|title=Xyz|pmc=333333|doi=10.0001/Rubbish_bot_failure_test|doi-access=free}}';
        $template = $this->make_citation($text);
        $this->assertTrue($template->get_identifiers_from_url());
        $this->assertNull($template->get2('url'));
    }
    ...
    public function testRemoveNoAccessMessageFromOUPWithArchive(): void {
        $text = '{{cite journal|url=https://academic.oup.com/gji/article-abstract/230/1/50/6522179#no-access-message|archive-url=https://web.archive.org/web/20221010045451/https://academic.oup.com/gji/article-abstract/230/1/50/6522179#no-access-message|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $template->tidy_parameter('url');
        $this->assertSame('https://academic.oup.com/gji/article-abstract/230/1/50/6522179', $template->get2('url'));
    ...
    public function testRemoveNoAccessMessageFromBBC(): void {
        $text = '{{cite web|url=https://www.bbc.com/news/articles/cwyw4x39jdwo#no-access-message|archive-url=https://web.archive.org/web/20251226110705/https://www.bbc.com/news/articles/cwyw4x39jdwo#no-access-message|pmid=<!-- -->|pmc=<!-- -->|arxiv=<!-- -->}}';
        $template = $this->make_citation($text);
        $template->tidy_parameter('url');
