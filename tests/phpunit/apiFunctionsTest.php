...
final class apiFunctionsTest extends testBaseClass {
  ...
  public function testExpansion_doi_not_from_crossrefBook() {
     ...
     $this->assertSame('{{Cite book|year = 1996|isbn = 9780511983658|last1 = Luo|first1 = Zhi-Quan|title = Mathematical Programs with Equilibrium Constraints|last2 = Pang|first2 = Jong-Shi|last3 = Ralph|first3 = Daniel|publisher = Cambridge University Press}}', $expanded->parsed_text());
  }
