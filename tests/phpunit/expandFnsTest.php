...
final class expandFnsTest extends PHPUnit\Framework\TestCase {
  ...
  public function testMathInTitle() {
      ...
      $this->assertEquals($text_math,sanitize_string($text_math));
      $this->assertEquals($text_math,wikify_external_text($text_math));
      ...
      $this->assertEquals($text_math,wikify_external_text($text_mml));
  }
