...
final class gadgetTest extends testBaseClass {
  public function testGadget() : void {
      ...
      $this->assertSame('Something Nice | Alter: template type. Add: pages, issue, volume, journal, title, year, authors 1-2. Formatted [[WP:ENDASH|dashes]]. Removed Template redirect. | [[WP:UCB|Use this tool]] yourself. [[WP:DBUG|Report bugs]]. | via #UCB_Gadget ', $json->editsummary);
  }
}
