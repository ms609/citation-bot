...
class PageTest extends PHPUnit\Framework\TestCase {
  ...
  public function testUrlReferences() {
      ...
      $page = $this->process_page('URL reference test 2 <ref name="bob">[http://doi.org/10.1007/s12668-011-0022-5]< / ref> URL reference test 2');
      $this->assertEquals('URL reference test 2 <ref name="bob">{{Cite journal |doi = 10.1007/s12668-011-0022-5|title = Reoccurring Patterns in Hierarchical Protein Materials and Music: The Power of Analogies|journal = Bionanoscience|volume = 1|issue = 4|pages = 153–161|year = 2011|last1 = Giesa|first1 = Tristan|last2 = Spivak|first2 = David I|last3 = Buehler|first3 = Markus J|arxiv = 1111.5297}}< / ref> URL reference test 2', $page->parsed_text());
  }
