...
class PageTest extends PHPUnit\Framework\TestCase {
  ...
  public function testUrlReferences() {
      $page = $this->process_page('URL reference 1 <ref name="bob">http://doi.org/10.1007/s12668-011-0022-5< / ref> dfadsf <ref >  https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3705692/ </ref> URL reference 1');
      $this->assertEquals('URL reference 1 <ref name="bob">{{Cite journal |doi = 10.1007/s12668-011-0022-5|title = Reoccurring Patterns in Hierarchical Protein Materials and Music: The Power of Analogies|journal = Bionanoscience|volume = 1|issue = 4|pages = 153–161|year = 2011|last1 = Giesa|first1 = Tristan|last2 = Spivak|first2 = David I|last3 = Buehler|first3 = Markus J}}< / ref> dfadsf <ref >{{Cite journal|pmc = 3705692|year = 2013|last1 = Mahajan|first1 = P. T|title = Indian religious concepts on sexuality and marriage|journal = Indian Journal of Psychiatry|volume = 55|issue = Suppl 2|pages = S256–S262|last2 = Pimple|first2 = P|last3 = Palsetia|first3 = D|last4 = Dave|first4 = N|last5 = De Sousa|first5 = A|pmid = 23858264|doi = 10.4103/0019-5545.105547}}</ref> URL reference 1', $page->parsed_text());
      $page = $this->process_page('URL reference 2 <ref name="bob">[http://doi.org/10.1007/s12668-011-0022-5]< / ref> dfadsf <ref >  [https://www.ncbi.nlm.nih.gov/pmc/articles/PMC3705692/] </ref> URL reference 2');
      $this->assertEquals('URL reference 2 <ref name="bob">{{Cite journal |doi = 10.1007/s12668-011-0022-5|title = Reoccurring Patterns in Hierarchical Protein Materials and Music: The Power of Analogies|journal = Bionanoscience|volume = 1|issue = 4|pages = 153–161|year = 2011|last1 = Giesa|first1 = Tristan|last2 = Spivak|first2 = David I|last3 = Buehler|first3 = Markus J}}< / ref> dfadsf <ref >{{Cite journal|pmc = 3705692|year = 2013|last1 = Mahajan|first1 = P. T|title = Indian religious concepts on sexuality and marriage|journal = Indian Journal of Psychiatry|volume = 55|issue = Suppl 2|pages = S256–S262|last2 = Pimple|first2 = P|last3 = Palsetia|first3 = D|last4 = Dave|first4 = N|last5 = De Sousa|first5 = A|pmid = 23858264|doi = 10.4103/0019-5545.105547}}</ref> URL reference 2', $page->parsed_text());
  }
