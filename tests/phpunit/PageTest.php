...
final class PageTest extends testBaseClass {
  ...
  public function testPageChangeSummary31() : void {
      ...
      $this->assertSame('Alter: template type. Add: s2cid, pages, issue, volume, journal, year, title, doi, authors 1-2. Changed bare reference to CS1/2. | [[WP:UCB|Use this bot]]. [[WP:DBUG|Report bugs]]. ', $page->edit_summary());                
  }
