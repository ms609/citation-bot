...
final class PageTest extends testBaseClass {
  ...
  public function testUrlReferencesWithText6() : void {
      ...
      $page = $this->process_page($text);
      $this->assertSame('<ref>{{Cite journal|doi = 10.1080/13537113.2015.1032033|title = Canadian Multiculturalism and the Absence of the Far Right|year = 2015|last1 = Ambrose|first1 = Emma|last2 = Mudde|first2 = Cas|journal = Nationalism and Ethnic Politics|volume = 21|issue = 2|pages = 213–236|s2cid = 145773856}}</ref>', $page->parsed_text());
  }
  ...
  public function testUrlReferencesWithText7() : void {
      ...
      $page = $this->process_page($text);
      $this->assertSame('<ref>{{Cite journal|doi = 10.1007/s12052-007-0001-z|title = Evolution as Fact, Theory, and Path|year = 2008|last1 = Gregory|first1 = T. Ryan|journal = Evolution: Education and Outreach|volume = 1|pages = 46–52|s2cid = 19788314}}</ref>', $page->parsed_text());
  }
  ...
  public function testUrlReferencesWithText8() : void {
      ...
      $page = $this->process_page($text);
      $this->assertSame('<ref>{{Cite journal|doi = 10.1145/358589.358596|title = Improving computer program readability to aid modification|year = 1982|last1 = Elshoff|first1 = James L.|last2 = Marcotty|first2 = Michael|journal = Communications of the ACM|volume = 25|issue = 8|pages = 512–521|s2cid = 30026641}}</ref>', $page->parsed_text());
  }
  ...
  public function testBadPage() : void {  // Use this when debugging pages that crash the bot
    $bad_page = "Glossary_of_botanical_terms"; //  Replace with page name when debugging
