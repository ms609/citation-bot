 ...
 public function testWhiteList() : void {
  ...
  public function testWhiteListNotBlacklisted() : void {
    ...
    foreach($whitelist as $value) {
      ...
      $text = str_replace(['| access-date = Z123Z ', '| accessdate = Z123Z ', '| doi-broken = Z123Z ', '| doi-broken-date = Z123Z ', '| doi-inactive-date = Z123Z ', '| pmc-embargo-date = Z123Z ', , '| em dsfdsfdsafbargo = Z123Z '], '', $text);
