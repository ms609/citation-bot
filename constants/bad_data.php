...
const NON_JOURNAL_DOIS = const array('10.5531/db.vz.0001'); // lowercase exact matches
const NON_JOURNALS = const array('Amphibian Species of the World', 'an Online Reference', 'An Online Reference'); // Case-sensitive sub-string
const ARE_MAGAZINES = const array('the new yorker'); // lowercase axact matches
const ARE_NEWSPAPERS = const array('the economist'); // lowercase axact matches
const NO_PUBLISHER_NEEDED = const array('los angeles times', 'new york times magazine', 'the new york times',
