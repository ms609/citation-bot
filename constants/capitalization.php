...
const LC_SMALL_WORDS = array(/* The following will be automatically updated to alphabetical order */
          ...
          " into ", " is ", " its ", " IUCN ", " JAMA ", " JAMA: ", " la ", 
          " las ", " le ", " les ", " los ", " M.A. ", " M.D. ", " medRxiv ", " mit ", 
          " MNRAS ", " mot ", " N.Y. ", " N.Y.) ", " NASA ", " NEJM ", " non ", " nor ", 
          " NRC ", " NY ", " NYC ", " NYT ", " NZ ", " och ", " OECD ", " of ", " off ", 
          " og ", " on ", " or ", " over ", " P.E. ", " PC ", " PCR ", " per ", " Ph.D. ", 
          " PMLA ", " PNAS ", " PS: ", " R&D ", " RNA ", " RTÉ ", " S&P ", " SAE ", " SpringerPlus ", 
...
const JOURNAL_ACRONYMS = array(/* The following will be automatically updated to alphabetical order */
          ...
          " ChemPhysChem ", " ChemPlusChem ", " ChemSusChem ", " ChemSystemsChem ", " CLA Journal ", 
          " CMAJ ", " Combinatorial Math. and Combinatorial ", " CommLaw ", " CrystEngComm ", 
          " de la Plata ", " de la Plata ", " de la Plata ", " dell'Accademia ", " Des. ", 
          " Disease-a-Month ", " Drug Des Deliv ", " Drug Des Devel ", " Dtsch ", " Dtsch. ", " e-Collaboration ", 
          " e-Journal ", " e-Journal ", " e-Neuroforum ", " e-Neuroforum ", " e-Print ", 
          " e-Print ", " e-Prints ", " e-Prints ", " e-SPEN ", " e-SPEN ", " e-SPEN, ", 
          " e-SPEN, ", " E: ", " Early Modern Japan: an Interdisciplinary Journal ", " EBioMedicine ", 
          ...
          " Jpn. ", " l'IHÉS ", " l'IHÉS ", " l'IHÉS ", " l'IHÉS ", " La Trobe ", " Latina/o ", " Le Monde artiste ", " Ltd ", " MAA Focus ", 
          ...
          " NeuroImage ", " NeuroReport ", " Notes of the AAS ", " Novye i Maloizvestnye ", " Now and Then: ", " Ny Forskning i Grammatik ", 
