...
const LC_SMALL_WORDS = array(/* The following will be automatically updated to alphabetical order */
          ...
          " le ", " les ", " los ", " M.A. ", " M.D. ", " mit ", " MNRAS ", " mot ", " N.Y. ", 
          " N.Y.) ", " NASA ", " NEJM ", " non ", " nor ", " NRC ", " NY ", " NYC ", " NYT ", 
          " NZ ", " och ", " OECD ", " of ", " off ", " og ", " on ", " or ", " over ", 
          " P.E. ", " PCR ", " per ", " Ph.D. ", " PMLA ", " PNAS ", " PS: ", " R&D ", " RNA ", " RTÉ ", 
          " S&P ", " SAE ", " SpringerPlus ", " SSRN ", " TCI: ", " TESOL ", " the ", " then ", " till ", 
...
const JOURNAL_ACRONYMS = array(/* The following will be automatically updated to alphabetical order */
          ...
          " B/gcvs ", " B/gcvs ", " Bild am Sonntag ", " BioEssays ", " bioRxiv ", " bioRxiv ", " BJOG ", " BMJ ", 
          ...
          " eJournal ", " eJournal ", " Eksperimental'naia i Klinicheskaia ", " Eksperimental'noi i Teoreticheskoi ", " eLife ", 
          ...
          " Ocean Science Journal : Osj ", " PAJ: A Journal of Performance and Art ", " PALAIOS ", " PalAsiatica ",
          ...
          " STDs ", " Série A ", " Tae Kwon Do Times ", " TAPPI Journal ", " Tellus A ", " The Annals of the American Academy ", " The De Paulia ", " The EMBO Journal ", " Tidsskr Nor Lægeforen ", 
          ...
          " USGS ", " v Astronomicheskii Zhurna ", " WRIR ", " z/Journal ", " z/Journal ", " Znanosti i Umjetnosti ",
...
const UCFIRST_JOURNAL_ACRONYMS = array(/* The following will be automatically updated to alphabetical order */
          ...
          " Palaios ", " Palasiatica ", " Palz ", " Peerj ", " Pharmsci ", " Phytokeys ", " Pis'ma V Astronomicheskii ", 
          " PLoS ", " PLos ", " PloS ", " Plos ", " plos ", " PLOS One ", " Pnas ", " Proceedings of the Ire ", 
          " Protein Eng des Sel ", " PRZ ", " PRZ. ", " Published In: ", " Rna ", " S.a.p.i.en.s ", 
          " Scalacs ", " SCH ", " SCR. ", " Sicot-J ", " SRP Arh Celok Lek ", " Star Trek: The Official Monthly Magazine ", " STD & Aids ",
          " STDS ", " Série a ", " Tae Kwon do Times ", " Tappi Journal ", " Tellus a ", " The ANNALS of the American Academy ", " The de Paulia ", " The Embo Journal ", " Tidsskr nor Lægeforen ", 
