...
const LC_SMALL_WORDS = array(/* The following will be automatically updated to alphabetical order */
          ...
          " but ", " by ", " CBC ", " CNS ", " d'un ", " d'une ", " D.C. ", " da ", " dans ", 
          " das ", " DC ", " de ", " dei ", " del ", " della ", " delle ", " dem ", " den ", 
          " der ", " des ", " di ", " die ", " DNA ", " do ", " du ", " e ", " ed ", " ee ", 
          " ein ", " eine ", " einen ", " el ", " else ", " EMBO ", " en ", " et ", " FASEB ", 
          " FDA ", " FEBS ", " FEMS ", " for ", " from ", " för ", " für ", " HIV ", 
          " HIV/AIDS ", " HLA ", " HTMLGIANT ", " IBM ", " ICES ", " IEEE ", " if ", " ILR ", 
          " in ", " into ", " is ", " its ", " JAMA ", " JAMA: ", " la ", " las ", " le ", 
          " les ", " los ", " mit ", " MNRAS ", " mot ", " N.Y. ", " N.Y.) ", " NASA ", 
          " NEJM ", " non ", " nor ", " NRC ", " NY ", " NYC ", " NYT ", " NZ ", " och ", 
          " OECD ", " of ", " off ", " og ", " on ", " or ", " over ", " PCR ", " per ", 
...
const JOURNAL_ACRONYMS = array(/* The following will be automatically updated to alphabetical order */
          ...
          " CMAJ ", " CommLaw ", " CrystEngComm ", " dell'Accademia ", " Drug Des Devel Ther ", 
          " Dtsch ", " Dtsch. ", " e-Collaboration ", " e-Journal ", " e-Journal ", " e-Neuroforum ", 
          " e-Neuroforum ", " e-Print ", " e-Print ", " e-Prints ", " e-Prints ", " Early Modern Japan: an Interdisciplinary Journal ", 
          " ecancermedicalscience ", " eCrypt ", " eCrypt ", " EFSA ", " eGEMs ", " eGEMs ", 
          " eJournal ", " eJournal ", " Eksperimental'naia i Klinicheskaia ", " eLife ", 
          ...
          " eScholarship ", " eVolo ", " eVolo ", " eWeek ", " eWeek ", " FASEB J ", " FASEB J. ", 
          ...
          " i ee ", " i Teplovoznaja ", " iConference ", " IDCases ", " IEEE/ACM ", " IEEE/ACM ", " IFAC-PapersOnLine ", 
          " iJournal ", " iJournal ", " im Gesundheitswesen ", " Inside Higher Ed ", " iPhone ", 
          " iScience ", " iScience ", " ISME ", " ISRN Genetics ", " J Gerontol A Biol Sci Med Sci ", 
          ...
          " MERIP ", " Methods in Molecular Biology ", " mHealth ", " mHealth ", " MicrobiologyOpen ", " MIS Quarterly ", 
          ...
          " Ocean Science Journal : Osj ", " PAJ: A Journal of Performance and Art ", " PALAIOS ", " PalZ ",
          " PeerJ ", " PharmSci ", " PhytoKeys ", " Pis'ma v Astronomicheskii ", " PLOS ", " PLOS ", 
          " PLOS ", " PLOS ", " PLOS ", " PLOS ONE ", " PNAS ", " Proceedings of the IRE ", " Prz ", " Prz. ",
          " Published in: ", " RNA ", " S.A.P.I.EN.S ", " SCALACS ", " Sch ", " Scr. ", " Srp Arh Celok Lek ", 
          " Star Trek: The Official Monthly Magazine ", " STDs ", " Série A ", " TAPPI Journal ", 
          " Tellus A ", " The De Paulia ", " The EMBO Journal ", " Time Off Magazine ", 
          ...
          " Zeitschrift für Physik A: Hadrons and Nuclei ", " ZooKeys ", /* The above will be automatically updated to alphabetical order */ 
);
...
const UCFIRST_JOURNAL_ACRONYMS = array(/* The following will be automatically updated to alphabetical order */
          ...
          " JPN. ", " la Trobe ", " Latina/O ", " LTD ", " MAbs ", " Mabs ", " MBio ", 
          " Mbio ", " Med SCH ", " Medchemcomm ", " Meddelelser Om Grønland ", " Meddelelser Om Grønland, ", 
          " Merip ", " Methods in Molecular Biology (Clifton, N.j.) ", " MHealth ", " Mhealth ", " Microbiologyopen ",
