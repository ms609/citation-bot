...
const LC_SMALL_WORDS = array(/* The following will be automatically updated to alphabetical order */
          ...
          " HLA ", " HortScience ", " HTMLGIANT ", " IBM ", " ICES ", " IEEE ", " if ", 
          " ILR ", " in ", " INFLIBNET ", " into ", " is ", " its ", " IUCN ", " JAMA ", 
          " JAMA: ", " la ", " las ", " le ", " les ", " los ", " LRTAP ", " M.A. ", " M.D. ", 
          " medRxiv ", " mit ", " MNRAS ", " mot ", " N.Y. ", " N.Y.) ", " N.Z. ", " N.Z.) ", 
          " NASA ", " NEJM ", " NIH ", " non ", " nor ", " NRC ", " NY ", " NY) ", " NYC ", 
          " NYT ", " NZ ", " NZ) ", " och ", " OECD ", " of ", " off ", " og ", " on ", 
          " or ", " over ", " P.E. ", " PC ", " PCR ", " per ", " Ph.D. ", " PMLA ", " PNAS ", 
          " PS: ", " R&D ", " RNA ", " RTÉ ", " S&P ", " SAE ", " SciPost ", " SMPTE ", 
          " SPIE ", " SpringerPlus ", " SSRN ", " TAPPI ", " TCI: ", " te ", " TESOL ", 
...
const JOURNAL_ACRONYMS = array(/* The following will be automatically updated to alphabetical order */
          ...
          " ACM SIGGRAPH ", " ACS ", " AIDS & Behavior ", " AIDS and Behavior ", " AIDS Care ", 
          " AIDS Research ", " AIMS Microbiology ", " AJNR. ", " Algebra i Analiz ", " Algebra i Logika ", 
          " Amphibian Species of the World: an Online Reference. ", " Angew Chem Int Ed ", 
          " AOAC International ", " AORN J ", " AORN J. ", " Applied ", " APS Division ", 
          ...
          " BJOG: ", " BMJ ", " CBD Ubiquitin ", " CFSK-DT ", " ChemBioChem ", " ChemCatChem ", 
          ...
          " ChemSystemsChem ", " Chest ", " CHIMIA ", " CHINOPERL ", " CLA Journal ", " CMAJ ", 
          " Combinatorial Math. and Combinatorial ", " CommLaw ", " CrystEngComm ", " Cutter IT Journal ", 
          " CytoJournal ", " de la Plata ", " de la Plata ", " de la Plata ", " dell'Accademia ", 
          " Des. ", " Disease-a-Month ", " Drug Des Deliv ", " Drug Des Devel ", " Dtsch ", 
          ...
          " EBioMedicine ", " ecancermedicalscience ", " eClinicalMedicine ", " eClinicalMedicine ", " eCrypt ", " eCrypt ", " eEarth ", 
          ...
          " HannahArendt.net ", " hessenARCHÄOLOGIE ", " hessenARCHÄOLOGIE ", " History of Science; An Annual Review of Literature ", 
          " HIV & AIDS ", " HIV and AIDS ", " HIV/AIDS ", " HIV/AIDS ", " HOAJ biology ", 
          " Hoppe-Seyler's ", " hprints ", " Hylli i Dritës ", " i ee ", " i ee ", " i Teplovoznaja ", 
          " i-Perception ", " iConference ", " IDCases ", " IEEE/ACM ", " IEEE/ACM ", " IFAC Proceedings ", 
          ...
          " l'IHÉS ", " l'IHÉS ", " l'IHÉS ", " L. Sch. L. ", " La Trobe ", " Latina/o ", " Le chemin de fer ", " Le chemin de fer ",
          " Le Monde artiste ", " Ltd ", " MAA Focus ", " mAbs ", " mAbs ", " Marion E. Wade ", 
          " mBio ", " mBio ", " Med Sch ", " MedChemComm ", " Meddelelser om Grønland ", 
          " Meddelelser om Grønland, ", " medRxiv ", " Medscape ", " MERIP ", " Methods in Molecular Biology ", 
          ...
          " Notes of the AAS ", " Novye i Maloizvestnye ", " Now and Then: ", " npj Aging ", 
          " Ny Forskning i Grammatik ", " Nyt Tidsskrift ", " Obsidian II ", " Ocean Science Journal : Osj ", 
          ...
          " Protein Eng Des Sel ", " Prz ", " Prz. ", " Published in: ", " Rev Sci Tech Off Int Epiz ", 
          " Revista del Museo de La Plata ", " RNA ", " S.A.P.I.EN.S ", " S.A.P.I.EN.S. ", 
          " Saggiatore musicale ", " SCALACS ", " Sch ", " Scr. ", " SIAM Journal on ", 
          " SIAM Review ", " SICOT-J ", " SPUMS J ", " Srp Arh Celok Lek ", " Star Trek: The Official Monthly Magazine ", 
          " STD & AIDS ", " STDs ", " Swiss express: the Swiss Railways Society journal ", " Série A ", " Séries A et B ", " Tae Kwon Do ", 
          " TAPPI Journal ", " Tech off Int Epiz ", " Tellus A ", " Terra plana ", " Thai For Bull ", " The ALAN Review ", 
...
const UCFIRST_JOURNAL_ACRONYMS = array(/* The following will be automatically updated to alphabetical order */
          ...
          " Aids Research ", " Aims Microbiology ", " Ajnr. ", " Algebra I Analiz ", " Algebra I Logika ", 
          " Amphibian Species of the World: An Online Reference. ", " Angew Chem Int ed ", 
          " AOAC INTERNATIONAL ", " Aorn J ", " Aorn J. ", " Appiled ", " Aps Division ", 
          " Arch Dis Child Fetal Neonatal ed ", " ARCTIC ", " Asaio ", " Asme Aes ", " Asme MTD ", 
          " Avtomatika I Telemekhanika ", " B/GCVS ", " B/Gcvs ", " b/gcvs ", " Bild Am Sonntag ", 
          " Bioessays ", " Biomed Research International ", " BioRxiv ", " Biorxiv ", " Bjog ", 
          " Bjog: ", " Bmj ", " Cbd Ubiquitin ", " CFSK-Dt ", " Chembiochem ", " Chemcatchem ", 
          ...
          " Le Monde Artiste ", " LTD ", " Maa Focus ", " MAbs ", " Mabs ", " Marion e. Wade ", 
          " MBio ", " Mbio ", " Med SCH ", " Medchemcomm ", " Meddelelser Om Grønland ", 
          " Meddelelser Om Grønland, ", " MedRxiv ", " MedScape ", " Merip ", " Methods in Molecular Biology (Clifton, N.j.) ", 
          " MHealth ", " Mhealth ", " Microbiologyopen ", " Mikologiya I Fitopatologiya ", 
          " Mis Quarterly ", " MLife ", " Mlife ", " Molecular and Cellular Biology ", 
          " Montana the Magazine of Western History ", " MSphere ", " Msphere ", " MSystems ", 
          " Msystems ", " Mycokeys ", " N.Paradoxa ", " Nasa Tech Briefs ", " Nauka I Zhizn ", 
