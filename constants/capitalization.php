...
const LC_SMALL_WORDS = array(/* The following will be automatically updated to alphabetical order */
          ...
          " be ", " bei ", " BJPsych ", " BJU ", " BMC ", " BMJ ", " but ", " by ", " CBC ", " CJEM ",
...
const JOURNAL_ACRONYMS = array(/* The following will be automatically updated to alphabetical order */
          ...
          " ChemSystemsChem ", " Chest ", " CHIMIA ", " CHINOPERL ", " CLA Journal ", " CMAJ ", " Combinatorial Math. and Combinatorial ", 
          " CommLaw ", " CrystEngComm ", " Cutter IT Journal ", " CytoJournal ", " de la Plata ", " de la Plata ", 
          " de la Plata ", " dell'Accademia ", " Des. ", " Disease-a-Month ", " Drug Des Deliv ", 
          " Drug Des Devel ", " Dtsch ", " Dtsch. ", " e-Collaboration ", " e-Health ", 
          " e-Journal ", " e-Journal ", " e-Neuroforum ", " e-Neuroforum ", " e-Print ", 
          " e-Print ", " e-Prints ", " e-Prints ", " e-SPEN ", " e-SPEN ", " e-SPEN, ", 
          " e-SPEN, ", " E. M. Museum ", " E: ", " Early Modern Japan: an Interdisciplinary Journal ", 
          ...
          " für anorganische und allgemeine ", " GigaScience ", " Gigiena i Sanitariia ", " HannahArendt.net ", 
          ...
          " Journal sur ", " Jpn ", " Jpn. ", " Katorga i Ssylka ", " Keel ja ", " l'IHÉS ", " l'IHÉS ", " l'IHÉS ", " l'IHÉS ", 
          " L. Sch. L. ", " La Trobe ", " Latina/o ", " Le Monde artiste ", " Ltd ", " MAA Focus ", 
          ...
          " Notes of the AAS ", " Novye i Maloizvestnye ", " Now and Then: ", " npj Aging ", " Ny Forskning i Grammatik ", 
          ...
          " Prz ", " Prz. ", " Published in: ", " Rev Sci Tech Off Int Epiz ", " Revista del Museo de La Plata ", " RNA ", 
          ...
          " Séries A et B ", " Tae Kwon Do ", " TAPPI Journal ", " Tech off Int Epiz ", 
          " Tellus A ", " Thai For Bull ", " The ALAN Review ", " The Annals of the American Academy ", " The De Paulia ", 
          " The EMBO Journal ", " The La Salle Collegian ", " The New Yorker ", " Tidsskr Nor Laegeforen ", 
          ...
          " USGS ", " v Astronomicheskii Zhurna ", " Verslag van Het Friesch ", " voor de geschiedenis der Nederlanden ", 
...
const UCFIRST_JOURNAL_ACRONYMS = array(/* The following will be automatically updated to alphabetical order */
          ...
          " Novye I Maloizvestnye ", " Now and then: ", " NPJ Aging ", " NY Forskning I Grammatik ", " NYT Tidsskrift ", 
          ...
          " Séries a et B ", " Tae Kwon do ", " Tappi Journal ", " Tech off int Epiz ", 
          " Tellus a ", " Thai for Bull ", " The Alan Review ", " The ANNALS of the American Academy ", " The de Paulia ", 
          " The Embo Journal ", " The la Salle Collegian ", " The New Yorker (Serial) ", 
