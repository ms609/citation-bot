...
const LC_SMALL_WORDS = array(/* The following will be automatically updated to alphabetical order */
          ...
          " D.Div. ", " D.M.D. ", " D.P.M. " , " M.S. ", " D.Sc. ", " da ", " dans ", " das ", 
          " DC ", " de ", " dei ", " del ", " della ", " delle ", " dem ", " den ", " der ", 
          " des ", " di ", " die ", " DNA ", " do ", " du ", " e ", " EcoSal ", " ed ", 
          " ee ", " eEarth ", " EFORT ", " ein ", " eine ", " einen ", " EJNMMI ", " el ", 
          " else ", " EMBO ", " en ", " EPJ ", " ESMO ", " et ", " EURASIP ", " FASEB ", 
          " FDA ", " FEBS ", " FEMS ", " for ", " from ", " för ", " før ", " für ", 
          " GSA ", " HIV ", " HLA ", " HortScience ", " HTMLGIANT ", " IBM ", " ICES ", 
          " IEEE ", " IETF ", " if ", " ILR ", " in ", " INFLIBNET ", " into ", " is ", 
          " its ", " IUCN ", " JAMA ", " JAMA: ", " la ", " las ", " le ", " les ", " los ", 
          " LRTAP ", " M.A. ", " M.D. ", " medRxiv ", " mit ", " MNRAS ", " mot ", " N.Y. ", 
          " N.Y.) ", " N.Z. ", " N.Z.) ", " NASA ", " NEJM ", " NIH ", " non ", " nor ", 
...
const JOURNAL_ACRONYMS = array(/* The following will be automatically updated to alphabetical order */
          ...
          " BioEssays ", " BioMed Research International ", " bioRxiv ", " bioRxiv ", " BioTechniques ", " BJOG ", 
          ...
          " eScholarship ", " eScience ", " eScience ", " eScripta ", " eScripta ", " EuroIntervention ", " eVolo ", 
