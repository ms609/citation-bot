...
const LC_SMALL_WORDS = array(/* The following will be automatically updated to alphabetical order */
          ...
          " for ", " from ", " för ", " für ", " HIV ", " HIV/AIDS ", " HIV/AIDS ", " HLA ", 
	  " HTMLGIANT ", " IBM ", " ICES ", " IEEE ", " if ", " ILR ", " in ", " into ", 
...
const JOURNAL_ACRONYMS = array(/* The following will be automatically updated to alphabetical order */
          ...
          " CMAJ ", " dell'Accademia ", " Drug Des Devel Ther ", " Dtsch ", " Dtsch. ", " e-Collaboration ",
	  ...
	  " eNeurologicalSci ",  " eNeurologicalSci ",  " eNeurologicalSci ", " engrXiv ", 
          ...
          " JAMA Psychiatry ", " JNCI: Journal ", " Journal of Materials Chemistry A ", " Journal of the A.I.E.E. ", 
          " Journal of the IEST ", " Journal sur ", " Jpn ", " Jpn. ", " La Trobe ", " Latina/o ", " Ltd ", 
          ...
          " mHealth ", " MIS Quarterly ", " Molecular and Cellular Biology ", " Montana The Magazine of Western History ", 
          " mSphere ", " mSphere ", " mSystems ", " mSystems ", " MycoKeys ", " n.paradoxa ", " NASA Tech Briefs ", " Nauka i Zhizn ",
          ...
          " PLOS ", " PLOS ", " PLOS ", " PLOS ", " PLOS ONE ", " PNAS ", " Proceedings of the IRE ", " Published in: ", " RNA ", " S.A.P.I.EN.S ", 
...
const UCFIRST_JOURNAL_ACRONYMS = array(/* The following will be automatically updated to alphabetical order */ 
	  ...
	  " ENeurologicalSci ",  " ENeurologicalsci ", " Eneurologicalsci ", " EngrXiv ", 
          ...
          " Iphone ", " IScience ", " Iscience ", " Isme ", " Isrn Genetics ", " J Gerontol a Biol Sci Med Sci ", 
          " J SCH Nurs ", " J Siam ", " J. Siam ", " Jabs : Journal of Applied Biological Sciences ", 
          " Jama Psychiatry ", " Jnci: Journal ", " Journal of Materials Chemistry A ", " Journal of the A.i.i.e ", 
          " Journal of the Iest ", " Journal Sur ", " JPN ", " JPN. ", " la Trobe ", " Latina/O ", " LTD ", 
          " MAbs ", " Mabs ", " MBio ", " Mbio ", " Med SCH ", " Medchemcomm ", " Meddelelser Om Grønland ", 
          " Meddelelser Om Grønland, ", " Merip ", " Methods in Molecular Biology (Clifton, N.j.) ", 
          " MHealth ", " Mhealth ", " Mis Quarterly ", " Molecular and Cellular Biology ", " Montana the Magazine of Western History ", 
          " MSphere ", " Msphere ", " MSystems ", " Msystems ", " Mycokeys ", " N.Paradoxa ", " Nasa Tech Briefs ", " Nauka I Zhizn ",
          " Nber ", " NDT & e International ", " Neuroreport ", " Notes of the Aas ", " NY Forskning I Grammatik ", 
          " NYT Tidsskrift ", " Ocean Science Journal : Osj ", " Paj: A Journal of Performance and Art ", 
          " Palaios ", " Peerj ", " Phytokeys ", " Pis'ma V Astronomicheskii ", " PLoS ", 
          " PLos ", " PloS ", " Plos ", " plos ", " PLOS One ",
          " Pnas ", " Proceedings of the Ire ", " Published In: ", " Rna ", " S.a.p.i.en.s ", 
          " SCH ", " SCR. ", " SRP Arh Celok Lek ", " Star Trek: The Official Monthly Magazine ", 
          " STDS ", " Série a ", " Tappi Journal ", " Tellus a ", " The de Paulia ", " The Embo Journal ", 
          " Time off Magazine ", " Time Out London ", " Tot de ", " Transactions and Archaeological Record of the Cardiganshire Antiquarian Society ", 
          " U.s. ", " U.S.a. ", " U.s.a ", " UHealth ", " Uhealth ", " Usgs ", " V Astronomicheskii Zhurna ", 
