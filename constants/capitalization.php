...
const LC_SMALL_WORDS = array(/* The following will be automatically updated to alphabetical order */
          ' AAUP ', ' ABC ', ' AC ', ' ACM ', ' AGU ', ' AI ', ' AIAA ', ' AJHG ', ' al ', 
          ' an ', ' and ', ' and then ', ' as ', ' at ', ' at ', ' aus ', ' av ', ' BBA ', 
          ' BBC ', ' be ', ' bei ', ' BJPsych ', ' BMC ', ' BMJ ', ' but ', ' by ', ' CBC ', 
          ' CNS ', ' d\'un ', ' d\'une ', ' da ', ' dans ', ' das ', ' DC ', ' de ', ' dei ', 
          ' del ', ' della ', ' delle ', ' dem ', ' den ', ' der ', ' des ', ' di ', ' die ', 
          ' DNA ', ' do ', ' du ', ' D.C. ', ' e ', ' ed ', ' ein ', ' eine ', ' einen ', 
          ' el ', ' else ', ' EMBO ', ' en ', ' et ', ' FASEB ', ' FDA ', ' FEBS ', ' FEMS ', 
          ' for ', ' from ', ' för ', ' für ', ' IEEE ', ' if ', ' ILR ', ' in ', ' into ', 
          ' is ', ' its ', ' JAMA ', ' JAMA: ', ' la ', ' las ', ' le ', ' les ', ' los ', 
          ' mit ', ' MNRAS ', ' mot ', ' NASA ', ' NEJM ', ' non ', ' nor ', ' N.Y. ', ' N.Y.) ', 
          ' NRC ', ' NY ', ' NYC ', ' NYT ', ' NZ ', ' och ', ' OECD ', ' of ', ' off ', 
          ' on ', ' og ', ' or ', ' over ', ' PCR ', ' per ', ' PNAS ', ' PS: ', ' R&D ', 
          ' RNA ', ' RTÉ ', ' S&P ', ' SAE ', ' SSRN ', ' TCI: ', ' the ', ' then ', ' till ', 
          ' to ', ' UK ', ' um ', ' und ', ' up ', ' USA ', ' van ', ' vir ', ' von ', 
          ' voor ', ' when ', ' with ', ' within ', ' woor ', ' y ', ' zu ', ' zum ', ' zur ', 
...
const JOURNAL_ACRONYMS = array(/* The following will be automatically updated to alphabetical order */
          ' (online ed.) ', ' AAPOS ', ' AAPS ', ' ACS ', ' Algebra i Analiz ', ' Angew Chem Int Ed ', 
          ...
          " dell'Accademia ",
          ' Drug Des Devel Ther ', ' Dtsch ', ' Dtsch. ', ' e-Journal ', 
          ...
          ' iJournal ', ' im Gesundheitswesen ', ' iPhone ', ' ISME ', ' ISRN Genetics ', ' J Gerontol A Biol Sci Med Sci ', 
          ' J Sch Nurs ', ' J SIAM ', ' J. SIAM ', ' JABS : Journal of Applied Biological Sciences ', ' JAMA Psychiatry ', 
          ...
          ' Molecular and Cellular Biology ', ' Montana The Magazine of Western History ', ' mSphere ', 
          ...
          ' PeerJ ', ' PhytoKeys ', ' Pis\'ma v Astronomicheskii ', ' PLOS Biology ', ' PLOS Medicine ', 
          ' PLOS Neglected Tropical Diseases ', ' PLOS ONE ', ' PLOS ONE ', ' PLOS ONE ', 
          ' PLOS ONE ', ' PNAS ', ' Published in: ', ' RNA ', ' S.A.P.I.EN.S ', ' Scr. ', 
          ' Srp Arh Celok Lek ', ' Star Trek: The Official Monthly Magazine ', ' STDs ', 
          ' Série A ', ' Tellus A ', ' The De Paulia ', ' The EMBO Journal ', ' Time Off Magazine ', 
          ' Time Out London ', ' tot de ', ' Transactions and archaeological record of the Cardiganshire Antiquarian Society ', ' U.S. ', 
          ' U.S.A. ', ' U.S.A. ', ' uHealth ', ' uHealth ', ' USGS ', ' v Astronomicheskii Zhurna ', ' WRIR ', 
