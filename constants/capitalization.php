...
const JOURNAL_ACRONYMS = array(/* The following will be automatically updated to alphabetical order */
          ...
          " ChemSystemsChem ", " CMAJ ", " CommLaw ", " CrystEngComm ", " dell'Accademia ", 
          " Des. ", " Drug Des Devel Ther ", " Dtsch ", " Dtsch. ", " e-Collaboration ", 
          " e-Journal ", " e-Journal ", " e-Neuroforum ", " e-Neuroforum ", " e-Print ", 
          " e-Print ", " e-Prints ", " e-Prints ", " E: ", " Early Modern Japan: an Interdisciplinary Journal ", 
          ...
          " ZooKeys ", " Combinatorial Math. and Combinatorial " /* The above will be automatically updated to alphabetical order */ 
);
