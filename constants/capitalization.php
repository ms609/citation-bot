...
const LC_SMALL_WORDS = array(/* The following will be automatically updated to alphabetical order */
          ...
          " des ", " di ", " die ", " DNA ", " do ", " du ", " e ", " ed ", " ee ", " ein ", 
          " eine ", " einen ", " el ", " else ", " EMBO ", " en ", " et ", " FASEB ", " FDA ", 
          " FEBS ", " FEMS ", " for ", " from ", " för ", " für ", " HIV ", " HIV/AIDS ", 
          " HLA ", " HTMLGIANT ", " IBM ", " ICES ", " IEEE ", " if ", " ILR ", " in ", 
          " into ", " is ", " its ", " JAMA ", " JAMA: ", " la ", " las ", " le ", " les ", 
          " los ", " mit ", " MNRAS ", " mot ", " N.Y. ", " N.Y.) ", " NASA ", " NEJM ", 
          " non ", " nor ", " NRC ", " NY ", " NYC ", " NYT ", " NZ ", " och ", " OECD ", 
          " of ", " off ", " og ", " on ", " or ", " over ", " PCR ", " per ", " PNAS ", 
          " PS: ", " R&D ", " RNA ", " RTÉ ", " S&P ", " SAE ", " SpringerPlus ", " SSRN ", 
          " TCI: ", " the ", " then ", " till ", " to ", " UK ", " um ", " und ", " up ", 
...
const JOURNAL_ACRONYMS = array(/* The following will be automatically updated to alphabetical order */
          ...
          " CBD Ubiquitin ", " CFSK-DT ", " ChemBioChem ", " ChemCatChem ", " ChemElectroChem ", " ChemistryOpen ", " ChemistrySelect ",
          " ChemistryViews ", " ChemMedChem ", " ChemPhotoChem ", " ChemPhysChem ", " ChemPlusChem ", " ChemSusChem ", " ChemSystemsChem ",
	  " CMAJ ", " CommLaw ", " CrystEngComm ", 
          " dell'Accademia ", " Drug Des Devel Ther ", " Dtsch ", " Dtsch. ", " e-Collaboration ", 
          ...
          " eCrypt ", " eCrypt ", " EFSA ", " eGEMs ", " eGEMs ", " eJournal ", " eJournal ", 
          " Eksperimental'naia i Klinicheskaia ", " eLife ", " eLife ", " eLS ", " eLS ", 
          ...
          " ePub ", " ePub ", " ePub) ", " ecancermedicalscience ", " eScholarship ", " eVolo ", " eVolo ", " eWeek ", 
          " eWeek ", " FASEB J ", " FASEB J. ", " FEBS J ", " FEBS J. ", " FEBS Journal ", 
          " Fizika Goreniya i Vzryva ", " Föreningen i Stockholm ", " für anorganische und allgemeine ", 
          ...
          " i ee ", " iConference ", " IDCases ", " IEEE/ACM ", " IEEE/ACM ", " IFAC-PapersOnLine ", 
          ...
          " MERIP ", " Methods in Molecular Biology ", " mHealth ", " mHealth ", " MIS Quarterly ", 
          ...
          " PLOS ", " PLOS ", " PLOS ", " PLOS ONE ", " PNAS ", " Proceedings of the IRE ", 
