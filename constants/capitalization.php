...
const LC_SMALL_WORDS = array(/* The following will be automatically updated to alphabetical order */
          ...
          " EMBO ", " en ", " EPJ ", " ESMO ", " et ", " EURASIP ", 
          " FASEB ", " FDA ", " FEBS ", " FEMS ", " for ", " from ", " för ", " før ", 
          " für ", " GSA ", " HIV ", " HLA ", " HortScience ", " HTMLGIANT ", " IBM ", 
          " ICES ", " IEEE ", " IETF ", " if ", " ILR ", " in ", " INFLIBNET ", " into ", 
          " is ", " its ", " IUCN ", " JAMA ", " JAMA: ", " la ", " las ", " le ", " les ", 
          " los ", " LRTAP ", " M.A. ", " M.D. ", " medRxiv ", " mit ", " MNRAS ", " mot ", 
          " N.Y. ", " N.Y.) ", " N.Z. ", " N.Z.) ", " NASA ", " NEJM ", " NIH ", " NIST ", 
          " non ", " nor ", " NRC ", " NY ", " NY) ", " NYC ", " NYT ", " NZ ", " NZ) ", 
          " och ", " OECD ", " of ", " off ", " og ", " on ", " or ", " over ", " P.E. ", 
          " PC ", " PCR ", " per ", " Ph.D. ", " PMLA ", " PNAS ", " PS: ", " R&D ", " RNA ", 
...
const JOURNAL_ACRONYMS = array(/* The following will be automatically updated to alphabetical order */
          ...
          " Arhiv za slovensku filologiju ", " Arhivski vjesnik ", " ASAIO ", " ASME AES ", 
          " ASME MTD ", " Avtomatika i Telemekhanika ", " B/gcvs ", " B/gcvs ", " B/gcvs ", 
          " Bibliotheca Enrico Damiani diretta da Nullo Minissi ", " Bibliotheca Enrico Damiani diretta da Nullo Minissi ", 
          " Bild am Sonntag ", " BioEssays ", " BioMed Research International ", " bioRxiv ", 
          " bioRxiv ", " BioTechniques ", " BJOG ", " BJOG: ", " BMJ ", " Bogoslovni vestnik ", 
          " Bogoslovska smotra ", " Bulletin za likovne umjetnosti Jugoslavenske akademije ", 
          " CardioVascular and Interventional Radiology ", " CBD Ubiquitin ", " CFSK-DT ", 
          " ChemBioChem ", " ChemCatChem ", " ChemElectroChem ", " ChemistryOpen ", " ChemistrySelect ", 
          " ChemistryViews ", " ChemMedChem ", " ChemPhotoChem ", " ChemPhysChem ", " ChemPlusChem ", 
          " ChemSusChem ", " ChemSystemsChem ", " Chest ", " Chicana/o-Latina/o Law Review ", 
          " CHIMIA ", " CHINOPERL ", " CLA Journal ", " CMAJ ", " Combinatorial Math. and Combinatorial ", 
          ...
          " dell'Accademia ", " Des Moines ", " Des. ", " Disease-a-Month ", " Drug Des Deliv ", 
          " Drug Des Devel ", " Dtsch ", " Dtsch. ", " e-Collaboration ", " e-Health ", 
          ...
          " eLife ", " eLS ", " eLS ", " eMagRes ", " eMagRes ", " EMBO J ", " EMBO J. ", " EMBO Journal ", " EMBO Rep ", 
          ...
          " ePub) ", " ESC Heart Failure ", " eScholarship ", " eScience ", " eScience ", 
          " eScripta ", " eScripta ", " EuroIntervention ", " eVolo ", " eVolo ", " eWeek ", 
          " eWeek ", " FASEB J ", " FASEB J. ", " FEBS J ", " FEBS J. ", " FEBS Journal ", 
          " Fizika Goreniya i Vzryva ", " Folia onomastica Croatica ", " For. Bull. ", 
          " Forhandlinger i Videnskabs-Selskabet i Christiania ", " Föreningen i Stockholm ", 
          " für anorganische und allgemeine ", " GeoJournal ", " GigaScience ", " Gigiena i Sanitariia ", 
          ...
          " Le chemin de fer ", " Le chemin de fer ", " Le Monde artiste ", " LISP and Symbolic Computation ", 
          " Ltd ", " MAA Focus ", " mAbs ", " mAbs ", " Marion E. Wade ", " mBio ", " mBio ", 
          " Med Sch ", " MedChemComm ", " Meddelelser om Grønland ", " Meddelelser om Grønland, ", 
          " MedPage ", " medRxiv ", " Medscape ", " MERIP ", " Methods in Molecular Biology ", 
          ...
          " PeerJ ", " PharmSci ", " PhD ", " PhytoKeys ", " Pis'ma v Astronomicheskii ", 
          ...
          " voor de geschiedenis der Nederlanden ", " VTK/UCT ", " We Proceeded On ", " WikiJournal ", 
...
const UCFIRST_JOURNAL_ACRONYMS = array(/* The following will be automatically updated to alphabetical order */
          ...
          " LTD ", " Maa Focus ", " MAbs ", " Mabs ", " Marion e. Wade ", " MBio ", " Mbio ", 
          " Med SCH ", " Medchemcomm ", " Meddelelser Om Grønland ", " Meddelelser Om Grønland, ", 
          " Medpage ", " MedRxiv ", " MedScape ", " Merip ", " Methods in Molecular Biology (Clifton, N.j.) ", 
          " MHealth ", " Mhealth ", " Microbiologyopen ", " Mikologiya I Fitopatologiya ", 
          " Mis Quarterly ", " MLife ", " Mlife ", " Molecular and cellular Biology ", 
          " Montana the Magazine of Western History ", " MSphere ", " Msphere ", " MSystems ", 
          " Msystems ", " Mycokeys ", " N.Paradoxa ", " Narodna Starina ", " Nasa Tech Briefs ", 
