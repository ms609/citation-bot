...
const LC_SMALL_WORDS = array(/* The following will be automatically updated to alphabetical order */
          ...
          " AIP ", " AJHG ", " al ", " an ", " and ", " and then ", " AOAC ", " as ", " at ", 
          " at ", " aus ", " av ", " BBA ", " BBC ", " be ", " bei ", " BJPsych ", " BMC ", 
          " BMJ ", " but ", " by ", " CBC ", " CNS ", " d'un ", " d'une ", " D.C. ", " D.C.L. ", 
          " D.D.S. ", " D.Div. ", " D.M.D. ", " D.P.M. " , " M.S. ", " D.Sc. ", " da ", 
          " dans ", " das ", " DC ", " de ", " dei ", " del ", " della ", " delle ", " dem ", 
          " den ", " der ", " des ", " di ", " die ", " DNA ", " do ", " du ", " e ", " ed ", 
          " ee ", " eEarth ", " ein ", " eine ", " einen ", " el ", " else ", " EMBO ", 
          " en ", " EPJ ", " et ", " FASEB ", " FDA ", " FEBS ", " FEMS ", " for ", " from ", 
          " för ", " für ", " HIV ", " HIV/AIDS ", " HLA ", " HTMLGIANT ", " IBM ", " ICES ", 
          " IEEE ", " if ", " ILR ", " in ", " INFLIBNET ", " into ", " is ", " its ", 
          " JAMA ", " JAMA: ", " la ", " las ", " le ", " les ", " los ", " M.A. ", " M.D. ", 
          " medRxiv ", " mit ", " MNRAS ", " mot ", " N.Y. ", " N.Y.) ", " NASA ", " NEJM ", 
          " non ", " nor ", " NRC ", " NY ", " NYC ", " NYT ", " NZ ", " och ", " OECD ", 
          " of ", " off ", " og ", " on ", " or ", " over ", " P.E. ", " PCR ", " per ", 
          " Ph.D. ", " PMLA ", " PNAS ", " PS: ", " R&D ", " RNA ", " RTÉ ", " S&P ", 
          " SAE ", " SpringerPlus ", " SSRN ", " TCI: ", " TESOL ", " the ", " then ", 
...
const JOURNAL_ACRONYMS = array(/* The following will be automatically updated to alphabetical order */
          ...
          " Applied ", " APS Division ", " Arch Dis Child Fetal Neonatal Ed ", " ASAIO ", 
          " ASME AES ", " ASME MTD ", " Avtomatika i Telemekhanika ", " B/gcvs ", " B/gcvs ", 
          " B/gcvs ", " Bild am Sonntag ", " BioEssays ", " bioRxiv ", " bioRxiv ", " BJOG ", 
          " BMJ ", " CBD Ubiquitin ", " CFSK-DT ", " ChemBioChem ", " ChemCatChem ", " ChemElectroChem ", 
          ...
          " CMAJ ", " CommLaw ", " CrystEngComm ", " dell'Accademia ", " Des. ", " Drug Des Devel Ther ", 
          " Dtsch ", " Dtsch. ", " e-Collaboration ", " e-Journal ", " e-Journal ", " e-Neuroforum ", 
          " e-Neuroforum ", " e-Print ", " e-Print ", " e-Prints ", " e-Prints ", " E: ", 
          " Early Modern Japan: an Interdisciplinary Journal ", " ecancermedicalscience ", 
          " eCrypt ", " eCrypt ", " eEarth ", " EFSA ", " eGEMs ", " eGEMs ", " eJournal ", 
          ...
          " EMBO Rep ", " EMBO Rep. ", " EMBO Reports ", " eNeuro ", " eNeuro ", " eNeurologicalSci ", 
          " eNeurologicalSci ", " eNeurologicalSci ", " engrXiv ", " ePlasty ", " ePlasty ", 
          " ePrint ", " ePrint ", " ePrints ", " ePrints ", " ePub ", " ePub ", " ePub) ", 
          " eScholarship ", " EuroIntervention ", " eVolo ", " eVolo ", " eWeek ", " eWeek ", 
          " FASEB J ", " FASEB J. ", " FEBS J ", " FEBS J. ", " FEBS Journal ", " Fizika Goreniya i Vzryva ", 
          " Föreningen i Stockholm ", " für anorganische und allgemeine ", " HannahArendt.net ", 
          " History of Science; An Annual Review of Literature ", " HOAJ biology ", " Hoppe-Seyler's ", 
          ...
          " NeuroReport ", " Notes of the AAS ", " Ny Forskning i Grammatik ", " Nyt Tidsskrift ", 
          ...
          " Saggiatore musicale ", " SCALACS ", " Sch ", " Scr. ", " SICOT-J ", " Srp Arh Celok Lek ", 
          ...
          " The De Paulia ", " The EMBO Journal ", " The New Yorker ", " Tidsskr Nor Laegeforen ", " Tidsskr Nor Lægeforen ", 
...
const UCFIRST_JOURNAL_ACRONYMS = array(/* The following will be automatically updated to alphabetical order */
          " (And the Middle East) ", " (Bba) ", " (online Ed.) ", " Aapos ", " Aaps ", 
          " ACM Siggraph ", " Acs ", " Ajnr. ", " Algebra I Analiz ", " Angew Chem Int ed ", 
          " Appiled ", " Aps Division ", " Arch Dis Child Fetal Neonatal ed ", " Asaio ", 
          " Asme Aes ", " Asme MTD ", " Avtomatika I Telemekhanika ", " B/GCVS ", " B/Gcvs ", 
          " b/gcvs ", " Bild Am Sonntag ", " Bioessays ", " BioRxiv ", " Biorxiv ", " Bjog ", 
          " Bmj ", " Cbd Ubiquitin ", " CFSK-Dt ", " Chembiochem ", " Chemcatchem ", " Chemelectrochem ", 
          " Chemistryopen ", " Chemistryselect ", " Chemistryviews ", " Chemmedchem ", 
          ...
          " Star Trek: The Official Monthly Magazine ", " STD & Aids ", " STDS ", " Série a ", 
          " Tae Kwon do Times ", " Tappi Journal ", " Tellus a ", " The ANNALS of the American Academy ", 
          " The de Paulia ", " The Embo Journal ", " The New Yorker (Serial) ", " Tidsskr nor Laegeforen ", " Tidsskr nor Lægeforen ", 
          " Time off Magazine ", " Time Out London ", " Tot de ", " Transactions and Archaeological Record of the Cardiganshire Antiquarian Society ", 
          " U.s. ", " U.S.a. ", " U.s.a ", " UHealth ", " Uhealth ", " Uned Research Journal ", 
          " Usgs ", " V Astronomicheskii Zhurna ", " Wrir ", " Z/Journal ", " Z/journal ", 
          " ZbMATH ", " Zeitschrift Für Geologische Wissenschaften ", " Zeitschrift für Physik a Hadrons and Nuclei ", 
