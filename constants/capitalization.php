...
const LC_SMALL_WORDS = array(/* The following will be automatically updated to alphabetical order */
          ...
          ' CBC ', ' CNS ', ' d\'un ', ' d\'une ', ' da ', ' dans ', ' das ', ' DC ', ' de ', 
          ' dei ', ' del ', ' della ', ' delle ', ' dem ', ' den ', ' der ', ' des ', ' di ', 
          ' die ', ' DNA ', ' do ', ' du ', ' D.C. ', ' e ', ' ed ', ' ein ', ' eine ', 
          ' einen ', ' el ', ' else ', ' EMBO ', ' en ', ' et ', ' FASEB ', ' FDA ', ' FEBS ', 
          ' FEMS ', ' for ', ' from ', ' för ', ' für ', ' IEEE ', ' if ', ' ILR ', ' in ', 
          ' into ', ' is ', ' its ', ' JAMA ', ' JAMA: ', ' la ', ' las ', ' le ', ' les ', 
          ' los ', ' mit ', ' MNRAS ', ' mot ', ' NASA ', ' NEJM ', ' non ', ' nor ', ' N.Y. ', 
          ' N.Y.) ', ' NRC ', ' NY ', ' NYC ', ' NYT ', ' NZ ', ' och ', ' OECD ', ' of ', 
          ' off ', ' on ', ' og ', ' or ', ' over ', ' PCR ', ' per ', ' PNAS ', ' PS: ', 
          ' R&D ', ' RNA ', ' RTÉ ', ' S&P ', ' SAE ', ' Sch ', ' SSRN ', ' TCI: ', ' the ', ' then ', 
...
const JOURNAL_ACRONYMS = array(/* The following will be automatically updated to alphabetical order */
          ...
          ' HOAJ biology ', " Hoppe-Seyler's ", ' hprints ', ' iConference ', ' IEEE/ACM ', ' IEEE/ACM ', ' IFAC-PapersOnLine ', 
          ' iJournal ', ' iJournal ', ' im Gesundheitswesen ', ' iPhone ', ' iScience ', ' iScience ', ' ISME ', ' ISRN Genetics ', 
