...
const JOURNAL_ACRONYMS = array(/* The following will be automatically updated to alphabetical order */
	  ...
	  " de la Plata, ", " de la Plata, ", " dell'Accademia ", " Des Moines ",
	  " Des. ", " Deutsches Ärzteblatt International ", " Disease-a-Month ",
	  " Drug Des Deliv ", " Drug Des Devel ", " Dtsch ", " Dtsch. ", " e-Collaboration ",
	  " e-Health ", " e-Journal ", " e-Journal ", " e-Neuroforum ", " e-Neuroforum ",
	  " e-Print ", " e-Print ", " e-Prints ", " e-Prints ", " e-Scripta ",
	  " e-Scripta ", " e-SPEN ", " e-SPEN ", " e-SPEN, ", " e-SPEN, ", " E. ",
