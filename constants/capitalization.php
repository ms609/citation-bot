...
const LC_SMALL_WORDS = array(/* The following will be automatically updated to alphabetical order */
          ...
          " AIChE ", " AIP ", " AJHG ", " al ", " an ", " and ", " and then ", " AOAC ", " APMIS ",
          " as ", " ASLIB ", " at ", " at ", " aus ", " av ", " BBA ", " BBC ", " be ", " bei ", " BJPsych ", " BJU ",
          ...
          " e ", " ed ", " ee ", " eEarth ", " EFORT ", " ein ", " eine ", " einen ", " EJNMMI ", " el ", " else ", 
          " EMBO ", " en ", " EPJ ", " ESMO ", " et ", " EURASIP ", " FASEB ", " FDA ", " FEBS ", " FEMS ", " for ", 
          " from ", " för ", " für ", " GSA ", " HIV ", " HIV/AIDS ", " HLA ", " HTMLGIANT ", 
          " IBM ", " ICES ", " IEEE ", " if ", " ILR ", " in ", " INFLIBNET ", " into ", 
          " is ", " its ", " IUCN ", " JAMA ", " JAMA: ", " la ", " las ", " le ", " les ", " los ", " l'IHÉS ",
          ...
          " S&P ", " SAE ", " SpringerPlus ", " SSRN ", " TAPPI ", " TCI: ", " te ", " TESOL ", " the ", " TheMarker ", " then ", 
...
const JOURNAL_ACRONYMS = array(/* The following will be automatically updated to alphabetical order */
          ...
          " ChemPhysChem ", " ChemPlusChem ", " ChemSusChem ", " ChemSystemsChem ", " CLA Journal ", " CMAJ ", 
          ...
          " Drug Des Devel ", " Dtsch ", " Dtsch. ", " e-Collaboration ", " e-Journal ", 
          ...
          " Eksperimental'noi i Teoreticheskoi ", " El Salvador ", " ELH ", " eLife ", " eLife ", " eLS ", " eLS ", 
          ...
          " ePub ", " ePub ", " ePub) ", " Esc Heart Failure ", " eScholarship ", " EuroIntervention ", " eVolo ", 
          ...
          " SCALACS ", " Sch ", " Scr. ", " SIAM Journal on ", " SIAM Review ", " SICOT-J ", " SPUMS J ",
