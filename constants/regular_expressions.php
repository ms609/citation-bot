...
const REGEXP_HANDLES = "~^(?:htt ps?://)(?:hdl\.handle\.net/|orbi\.ulg\.ac\.be/handle/|kb\.osu\.edu/dspace/handle/|oasis\.postech\.ac\.kr/handle/|idus\.us\.es/xmlui/handle/|dspace\.library\.uu\.nl/handle/)([^\?]*)~i";
