...
const TEMPLATES_WE_PROCESS = ['citation', 'cite arxiv', 'cite book', 'cite books', 'cite document',
...
const TEMPLATES_WE_CHAPTER_URL = ['new cambridge medieval history', 'setton-a history of the crusades', 'new cambridge medieval history',
...
const TEMPLATES_WE_HARV = ['cite iucn', 'cite odnb', 'cite dnb', 'dnb', 'dnbie', 'cite americana', 'cite eb1911', 'cite techreport',
...
const ALL_URL_TYPES = ['url', 'article-url', 'chapter-url', 'chapterurl', 'conference-url', 'conferenceurl',
...
const DATES_TO_CLEAN = ['air-date', 'airdate', 'archive-date', 'archivedate', 'date', 'pmc-embargo-date', 'publication-date', 'year',
...
const PARAMETER_LIST = [
 'ASIN', 'CITATION_BOT_PLACEHOLDER_BARE_URL', 'DOI', 'EISSN', 'HDL', 'ID', 'ISBN',\m  'ISMN', 'ISSN', 'JFM', 'JSTOR', 'LCCN', 'MR', 'OCLC', 'OL', 'OSTI', 'PMC', 'PMID',\m  'RFC', 'S2CID', 'SBN', 'SSRN', 'URL', 'ZBL', 'access-date', 'accessdate', 'agency',\m  'air-date', 'airdate', 'archive-date', 'archive-format', 'archive-url', 'archivedate',\m  'archiveurl', 'article', 'article-format', 'article-number', 'article-url', 'article-url-access',\m  'arxiv', 'asin', 'asin-tld', 'assign', 'assign#', 'assignee', 'at', 'audio-visual',\m  'author', 'author#', 'author#-first', 'author#-given', 'author#-last', 'author#-link',\m  'author#-mask', 'author#-surname', 'author#link', 'author-first', 'author-first#',\m  'author-given', 'author-given#', 'author-last', 'author-last#', 'author-link',\m  'author-link#', 'author-mask', 'author-mask#', 'author-surname', 'author-surname#',\m  'authorlink', 'authorlink#', 'authors', 'bibcode', 'bibcode-access', 'biorxiv',\m  'book-title', 'cartography', 'chapter', 'chapter-format', 'chapter-url', 'chapter-url-access',\m  'citation_bot_placeholder_bare_url', 'citeseerx', 'class', 'collaboration', 'conference',\m  'conference-format', 'conference-url', 'contribution', 'contribution-format',\m  'contribution-url', 'contribution-url-access', 'contributor', 'contributor#',\m  'contributor#-first', 'contributor#-given', 'contributor#-last', 'contributor#-link',\m  'contributor#-mask', 'contributor#-surname', 'contributor-first', 'contributor-first#',\m  'contributor-given', 'contributor-given#', 'contributor-last', 'contributor-last#',\m  'contributor-link', 'contributor-link#', 'contributor-mask', 'contributor-mask#',\m  'contributor-surname', 'contributor-surname#', 'country', 'country-code', 'credits',\m  'date', 'degree', 'department', 'description', 'df', 'dictionary', 'display-authors',\m  'display-contributors', 'display-editors', 'display-interviewers', 'display-subjects',\m  'display-translators', 'docket', 'doi', 'doi-access', 'doi-broken-date', 'edition',\m  'editor', 'editor#', 'editor#-first', 'editor#-given', 'editor#-last', 'editor#-link',\m  'editor#-mask', 'editor#-surname', 'editor-first', 'editor-first#', 'editor-given',\m  'editor-given#', 'editor-last', 'editor-last#', 'editor-link', 'editor-link#',\m  'editor-mask', 'editor-mask#', 'editor-surname', 'editor-surname#', 'eissn',\m  'encyclopaedia', 'encyclopedia', 'entry', 'entry-format', 'entry-url', 'entry-url-access',\m  'episode', 'episode-link', 'eprint', 'event', 'fdate', 'first', 'first#', 'format',\m  'gdate', 'given', 'given#', 'hdl', 'hdl-access', 'host', 'host#', 'id', 'inset',\m  'institution', 'interviewer', 'interviewer#', 'interviewer#-first', 'interviewer#-given',\m  'interviewer#-last', 'interviewer#-link', 'interviewer#-mask', 'interviewer#-surname',\m  'interviewer-first', 'interviewer-first#', 'interviewer-given', 'interviewer-given#',\m  'interviewer-last', 'interviewer-last#', 'interviewer-link', 'interviewer-link#',\m  'interviewer-mask', 'interviewer-mask#', 'interviewer-surname', 'interviewer-surname#',\m  'invent#', 'inventor', 'inventor#', 'inventor#-first', 'inventor#-given', 'inventor#-last',\m  'inventor#-link', 'inventor#-surname', 'inventor#link', 'inventor-first', 'inventor-first#',\m  'inventor-given', 'inventor-given#', 'inventor-last', 'inventor-last#', 'inventor-link',\m  'inventor-link#', 'inventor-surname', 'inventor-surname#', 'inventorlink', 'inventorlink#',\m  'isbn', 'ismn', 'issn', 'issue', 'issue-date', 'jfm', 'journal', 'jstor', 'jstor-access',\m  'lang', 'language', 'last', 'last#', 'lccn', 'location', 'magazine', 'mailing-list',\m  'map', 'map-format', 'map-url', 'map-url-access', 'medium', 'medrxiv', 'message-id',\m  'minutes', 'mode', 'mr', 'name-list-style', 'network', 'newsgroup', 'newspaper',\m  'no-pp', 'no-tracking', 'number', 'oclc', 'ol', 'ol-access', 'orig-date', 'orig-year',\m  'origyear', 'osti', 'osti-access', 'others', 'p', 'page', 'pages', 'patent-number',\m  'people', 'periodical', 'place', 'pmc', 'pmc-embargo-date', 'pmid', 'postscript',\m  'pp', 'pridate', 'pubdate', 'publication-date', 'publication-number', 'publication-place',\m  'publisher', 'quotation', 'quote', 'quote-page', 'quote-pages', 'ref', 'rfc',\m  's2cid', 's2cid-access', 'sbn', 'scale', 'script-article', 'script-chapter',\m  'script-contribution', 'script-encyclopaedia', 'script-encyclopedia', 'script-entry',\m  'script-journal', 'script-magazine', 'script-map', 'script-newspaper', 'script-periodical',\m  'script-quote', 'script-section', 'script-title', 'script-website', 'script-work',\m  'season', 'section', 'section-format', 'section-url', 'section-url-access', 'sections',\m  'series', 'series-link', 'series-no', 'series-number', 'sheet', 'sheets', 'ssrn',\m  'ssrn-access', 'station', 'status', 'subject', 'subject#', 'subject#-first',\m  'subject#-given', 'subject#-last', 'subject#-link', 'subject#-mask', 'subject#-surname',\m  'subject-first', 'subject-first#', 'subject-given', 'subject-given#', 'subject-last',\m  'subject-last#', 'subject-link', 'subject-link#', 'subject-mask', 'subject-mask#',\m  'subject-surname', 'subject-surname#', 'surname', 'surname#', 'template-doc-demo',\m  'time', 'time-caption', 'title', 'title-link', 'title-note', 'trans-article',\m  'trans-chapter', 'trans-contribution', 'trans-encyclopaedia', 'trans-encyclopedia',\m  'trans-entry', 'trans-journal', 'trans-magazine', 'trans-map', 'trans-newspaper',\m  'trans-periodical', 'trans-quote', 'trans-section', 'trans-title', 'trans-website',\m  'trans-work', 'transcript', 'transcript-format', 'transcript-url', 'translator',\m  'translator#', 'translator#-first', 'translator#-given', 'translator#-last',\m  'translator#-link', 'translator#-mask', 'translator#-surname', 'translator-first',\m  'translator-first#', 'translator-given', 'translator-given#', 'translator-last',\m  'translator-last#', 'translator-link', 'translator-link#', 'translator-mask',\m  'translator-mask#', 'translator-surname', 'translator-surname#', 'type', 'url',\m  'url-access', 'url-status', 'vauthors', 'veditors', 'version', 'via', 'volume',\m  'website', 'work', 'year', 'zbl'
];
