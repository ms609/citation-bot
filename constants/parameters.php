...
const DATES_TO_CLEAN = array('air-date', 'airdate', 'archive-date', 'archivedate', 'date', 'pmc-embargo-date', 'publication-date', 'year',
			     'lay-date', 'archive-date', 'archivedate', 'accessdate', 'access-date', 'orig-date', 'doi-broken-date');

const THINGS_THAT_ARE_TITLES = array('chapter', 'title', 'series', 'trans-title', 'book-title', 'contribution');
...
const PARAMETER_LIST = array(
  ...
  'script-contribution', 'script-entry', 'script-journal', 'script-magazine', 'script-map',
  'script-newspaper', 'script-periodical', 'script-quote', 'script-section', 'script-title',
  'script-website', 'script-work', 'season', 'section', 'section-format', 'section-url',
  'section-url-access', 'sections', 'series', 'series-link', 'series-no', 'series-number',
  'sheet', 'sheets', 'ssrn', 'ssrn-access', 'station', 'status', 'subject', 'subject#',
  'subject#-first', 'subject#-given', 'subject#-last', 'subject#-link', 'subject#-mask',
  'subject#-surname', 'subject-first', 'subject-first#', 'subject-given', 'subject-given#',
  'subject-last', 'subject-last#', 'subject-link', 'subject-link#', 'subject-mask',
  'subject-mask#', 'subject-surname', 'subject-surname#', 'surname', 'surname#',
  'template-doc-demo', 'time', 'time-caption', 'title', 'title-link', 'title-note',
  'trans-article', 'trans-chapter', 'trans-contribution', 'trans-entry', 'trans-journal',
  'trans-magazine', 'trans-map', 'trans-newspaper', 'trans-periodical', 'trans-quote',
  'trans-section', 'trans-title', 'trans-website', 'trans-work', 'transcript',
  'transcript-format', 'transcript-url', 'translator', 'translator#', 'translator#-first',
  'translator#-given', 'translator#-last', 'translator#-link', 'translator#-mask',
  'translator#-surname', 'translator-first', 'translator-first#', 'translator-given',
 ...
 const DEAD_PARAMETERS = array('PPPrefix', 'PPrefix', 'Ref', 'albumlink', 'albumtype',
     ...
     'lay-url', 'transcripturl', 'pages totales', 'ppprefix', 'pprefix');
