...
class WikipediaBot {
  ...
  public function fetch($params, $method = 'GET') {
    ...
    $request = Request::fromConsumerAndToken($this->consumer, $this->userEditToken, $method, API_ROOT, $params);
    $request->signRequest(new HmacSha1(), $this->consumer, $this->userEditToken);
  ...
  private function authenticate_user() {
    if (isset($_SESSION['access_key']) && isset($_SESSION['access_secret'])) {
      $this->userEditToken = new Token($_SESSION['access_key'], $_SESSION['access_secret']);
      return;
    }
    @session_destroy();
