  ...
  public function add_if_new($param_name, $value, $api = NULL) {
    ...
    switch ($param_name) {
      ...
      case 'periodical': case 'journal': case 'newspaper':
        ...
        if (!$this->blank(['agency','publisher']) && in_array(strtolower($value), DUBIOUS_PUBLISHERS) === TRUE) return FALSE; // non-journals that are probably same as agency or publisher that come from zotero
