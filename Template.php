    ...
    if (is_null($url_sent)) {
       // Chapter URLs are generally better than URLs for the whole book.
        if ($this->has('url') && $this->has('chapterurl')) {
           return $this->get_identifiers_from_url(Template::MAGIC_STRING . 'chapterurl ') ||
                  $this->get_identifiers_from_url(Template::MAGIC_STRING . 'url ');
        } elseif ($this->has('url') && $this->has('chapter-url')) {
           return $this->get_identifiers_from_url(Template::MAGIC_STRING . 'chapter-url ') ||
                  $this->get_identifiers_from_url(Template::MAGIC_STRING . 'url ');
        } elseif ($this->has('url')) {        
           $url = $this->get('url');
           $url_type = 'url';
