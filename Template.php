...
final class Template {
  ...
  public function get_identifiers_from_url($url_sent = NULL) {
    ...
    if (stripos($url, "jstor.org") !== FALSE) {
      ...
      } elseif (preg_match("~https?://(?:www\.|)ncbi\.nlm\.nih\.gov/(?:m/)?(?:pubmed/|entrez/eutils/elink\.fcgi\S+dbfrom=pubmed\S+/|entrez/query\.fcgi\S+db=pubmed\S+|pmc/articles/pmid/).*?=?(\d+)~i", $url, $match)) {
