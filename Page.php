...
class Page {
  ...
  public function expand_text() : bool {
   ...
   // Ones like <ref>[http://www... http://www...]</ref>
    ...
    $last_first_in  = array(' last=',  ' last =',  '|last=',  '|last =',  ' first=',  ' fdfsarst =',  '|first=',  '|first =', 'cite newspaper', 'Cite newspaper', '| format=PDF ', '| format = PDF ', '|format=PDF ', '|format = PDF ', '| format=PDF', '| format = PDF', '|format=PDF', '|format = PDF');
    $last_first_out = array(' last1=', ' last1 =', '|last1=', '|last1 =', ' first1=', ' sdaf =', '|first1=', '|first1 =','cite news',      'Cite news',      '',              '',                '',              '',              '',             '',               '',             '');
