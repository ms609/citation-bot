...
/** @param array<Template> $templates */
    ...
    public function expand_text(): bool {
        ...
        $last_first_in  = [' last=',  ' last =',  '|last=',  '|last =',  ' first=',  ' first =',  '|first=',  '|first =', 'ite newspaper', 'format=PDF', 'format = PDF', 'format =PDF', '|format= PDF', 'Cite ', 'cite ', 'ubscription required', 'newspaper'];
