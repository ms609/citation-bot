...
const TRANS_PARAMS = [
    ...
    'trans-chapter' => ['chapter', 'script-chapter'],
    'trans-article' => ['article', 'script-article'],
    'trans-contribution' => ['contribution', 'script-contribution'],
    'trans-entry' => ['entry', 'script-entry'],
    'trans-map' => ['map', 'script-map'],
    'trans-quote' => ['quote', 'script-quote'],
    'trans-journal' => ['journal', 'script-journal'],
    'trans-work' => ['work', 'script-work'],
    'trans-magazine' => ['magazine', 'script-magazine'],
    'trans-newspaper' => ['newspaper', 'script-newspaper'],
    'trans-website' => ['website', 'script-website'],
    'trans-encyclopaedia' => ['encyclopaedia', 'script-encyclopaedia'],
    'trans-encyclopedia' => ['encyclopedia', 'script-encyclopedia'],
    'trans-periodical' => ['periodical', 'script-periodical'],
    'trans-section' => ['section', 'script-section'],
];
...
function check_citation(Template $template): array {
    ...
    if ($template->has('hdl') && !hdl_valid($template->get('hdl'))) {
        $violations[] = 'hdl-malformed: CS1 "Check |hdl= value"';
    }
...
function build_matrix(): array {
    return [
        ...
        ['GAP malformed arxiv in input survives tidy', '{{cite journal |title=X |journal=J |arxiv=bogus}}', 'pass'],
