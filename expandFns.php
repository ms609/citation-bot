...
function convert_to_utf8(string $value) : string {
    $encode1 =  mb_detect_encoding($value, ["EUC-KR", "EUC-CN", "ISO-2022-JP", "WINDOWS-1252", "iso-8859-1", "UTF-8"]);
    if ($encode1 === FALSE || $encode1 === 'UTF-8') return $value;
    $encode2 =  mb_detect_encoding($value, ["EUC-CN", "EUC-KR", "ISO-2022-JP", "WINDOWS-1252", "iso-8859-1", "UTF-8"]);
    if ($encode1 !== $encode2) return $value;
    $encode3 =  mb_detect_encoding($value, ["ISO-2022-JP", "EUC-CN", "EUC-KR", "WINDOWS-1252", "iso-8859-1", "UTF-8"]);
    if ($encode1 !== $encode3) return $value;
    $encode4 =  mb_detect_encoding($value, ["iso-8859-1", "WINDOWS-1252", "ISO-2022-JP", "EUC-CN", "EUC-KR", "UTF-8"]);
