...
function is_doi_works(string $doi) : ?bool {
  ...
  if ($headers_test === FALSE) {
     ...
     if (empty($headers_test['Location']) || stripos($headers_test[0], '404 Not Found') !== FALSE || stripos($headers_test[0], 'HTTP/1.1 404') !== FALSE) {
       echo "\n second bad header for $doi ::: " .  @$headers_test['Location'] . "  :::  " . @$headers_test[0] . " \n";
     }
  }
