...
// Also need added to: both Page.php case statements, setup.php list of valid wikis, and both places in index.php
...
const MK_TRANS = [
    ...
    'Normalized parameter names. ' => 'Нормализирани имиња на параметри. ',
    'Removed redundant ref parameter. ' => 'Отстранет вишокот на ref параметар. ',
    'Removed invalid "n/a" parameter values. ' => 'Отстранети невалидни "n/a" вредности на параметри. ',
    'Removed unsupported issue parameter from cite book. ' => 'Отстранет неподдржан параметар issue од cite book. ',
    'Removed ODNBsub template. ' => 'Отстранет ODNBsub шаблон. ',
...
const RU_TRANS = [
    ...
    'Normalized parameter names. ' => 'Нормализованы имена параметров. ',
    'Removed redundant ref parameter. ' => 'Удален избыточный параметр ref. ',
    'Removed invalid "n/a" parameter values. ' => 'Удалены недопустимые значения параметров "n/a". ',
    'Removed unsupported issue parameter from cite book. ' => 'Удален неподдерживаемый параметр issue из cite book. ',
    'Removed ODNBsub template. ' => 'Удален шаблон ODNBsub. ',
...
const SR_TRANS = [
    ...
    'Normalized parameter names. ' => 'Нормализована имена параметара. ',
    'Removed redundant ref parameter. ' => 'Уклоњен сувишни ref параметар. ',
    'Removed invalid "n/a" parameter values. ' => 'Уклоњене неважеће "n/a" вредности параметара. ',
    'Removed unsupported issue parameter from cite book. ' => 'Уклоњен неподржани параметар issue из cite book. ',
    'Upgrade ISBN10 to 13. ' => 'Надограђен ISBN10 на ISBN13. ',
    'Removed Template redirect. ' => 'Уклоњено преусмерење шаблона. ',
    'Removed ODNBsub template. ' => 'Уклоњен ODNBsub шаблон. ',
...
const VI_TRANS = [
    ...
    'Normalized parameter names. ' => 'Đã chuẩn hóa tên tham số. ',
    'Removed redundant ref parameter. ' => 'Đã xóa tham số ref thừa. ',
    'Removed invalid "n/a" parameter values. ' => 'Đã xóa giá trị tham số "n/a" không hợp lệ. ',
    'Removed unsupported issue parameter from cite book. ' => 'Đã xóa tham số issue không được hỗ trợ khỏi cite book. ',
    'Removed ODNBsub template. ' => 'Đã xóa bản mẫu ODNBsub. ',
