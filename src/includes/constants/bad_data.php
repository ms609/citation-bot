...
const CANONICAL_PUBLISHER_URLS = [
    ...
    'ojs.ehu.eus',
    'ojs.umsa.bo/ojs',
    'open-journals.uni-tuebingen.de/ojs/index.php',
    'oxfordjournals.org',
    ...
    'revistas.ucm.es/index.php/ESMP/article/view',
    'revistas.ucr.ac.cr',
    'revistas.udd.cl',
    'revistas.unam.mx',
    'revistas.upr.edu',
    ...
    'rtyc.utn.edu.ar/index.php/rtyc/article/view',
    'saber.ucv.ve',
    'sagepub.com',
    ...
    'sciencemag.org',
    'sciopen.com/article',
    'scipublications.com/journal',
    'secreta-artis.ru',
    'seer.ufrgs.br/index.php/revistaihgrgs',
    'shs.cairn.info',
...
const ZOTERO_AVOID_REGEX = [
    ...
    'digital\.library\.unt\.edu', // Zotero gets inccorect data
...
const GOOD_10_1093_DOIS = [
    // Updated 22 August 2026 from OUP's Journals A to Z and changes to journal lists by year
    'abbs',
    'abm',
    'abt',
    'academicmedicine',
