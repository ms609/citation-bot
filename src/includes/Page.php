...
class Page {
    ...
    public function expand_text(): bool {
        ...
        $last_first_in = [' last=', ' last =', '|last=', '|last =', ' first=', ' first =', '|first=', '|first =', ' author-link=', ' author-link =', '|author-link=', '|author-link =', ' author-mask=', ' author-mask =', '|author-mask=', '|author-mask =', 'ite newspaper', '|format=PDF', '|format = PDF', '|format =PDF', '|format= PDF', '| format=PDF', '| format = PDF', '| format =PDF', '| format= PDF', '|format=PDF ', '|format = PDF ', '|format =PDF ', '|format= PDF ', '| format=PDF ', '| format = PDF ', '| format =PDF ', '| format= PDF ', 'Cite ', 'cite ', 'ubscription required', 'newspaper', ' title=', ' title =', '|title=', '|title =', ' url=', ' url =', '|url=', '|url ='];
        $last_first_out = [' last1=', ' last1 =', '|last1=', '|last1 =', ' first1=', ' first1 =', '|first1=', '|first1 =', ' author-link1=', ' author-link1 =', '|author-link1=', '|author-link1 =', ' author-mask1=', ' author-mask1 =', '|author-mask1=', '|author-mask1 =', 'ite news', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', 'Cite', 'cite', 'ubscription', 'work', ' chapter=', ' chapter =', '|chapter=', '|chapter =', ' chapter-url=', ' chapter-url =', '|chapter-url=', '|chapter-url ='];
        // @codeCoverageIgnoreStart
    ...
    private function set_date_pattern(): void {
        ...
        if (!in_array(WIKI_BASE, ENGLISH_WIKI, true)) { // anything that is not en, simple, mdwiki
